...
##as for number changing from 1 2 3 to one two three, not sure it yet, maybe in the libarary of synonyms database

f = open('/Users/tianhuihuang/Desktop/mc160.test.tsv')
...
#get the stop words, and stopwords means those words should be deleted
...
#here for entity(still need to be renamed)
# Read the file
# for entity part still have another reference
...
def run_tests():
    #test_tokenize_sentences() #split every text into sentence
    #test_tokenize_tokens() #split every sentence into words
    #test_stem()
    #test_fold_case()
